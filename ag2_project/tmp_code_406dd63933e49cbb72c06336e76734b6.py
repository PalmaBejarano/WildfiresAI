...
save_fig(fig, 'plot_01', 'energy_above_hull_vs_band_gap')
...
save_fig(fig, 'plot_02', 'band_gap_distribution')
...
ax.set_xlabel('Energy Above Hull (eV/atom)')
ax.set_ylabel('Frequency')
save_fig(fig, 'plot_03', 'energy_above_hull_frequency')
...
save_fig(fig, 'plot_04', 'energy_above_hull_vs_density')
...
ax.set_ylabel('Band Gap (eV)')
save_fig(fig, 'plot_05', 'density_vs_band_gap')
...
for i, (plot_id, slug, description) in enumerate([
    ('plot_01', 'energy_above_hull_vs_band_gap', 'Scatter of Energy Above Hull vs Band Gap'),
    ('plot_02', 'band_gap_distribution', 'Histogram of Band Gap Distribution'),
    ('plot_03', 'energy_above_hull_frequency', 'Histogram of Energy Above Hull Frequency'),
    ('plot_04', 'energy_above_hull_vs_density', 'Scatter of Energy Above Hull vs Density'),
    ('plot_05', 'density_vs_band_gap', 'Scatter of Density vs Band Gap'),
]):
