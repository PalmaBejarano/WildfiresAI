...
# Composite Scatter Plot of Density vs Band Gap with Stability Hue
plt.figure(figsize=(10, 6))
scatter = plt.scatter(density, band_gap, c=energy_above_hull, cmap='viridis', alpha=0.7)
plt.colorbar(scatter, label='Energy Above Hull (eV/atom)')
plt.title('Composite Scatter Plot of Density vs Band Gap with Stability Hue')
plt.xlabel('Density (g/cm3)')
plt.ylabel('Band Gap (eV)')
plt.grid(True)
plt.savefig('plots/P08_composite_density_bandgap_stability.png')
plt.close()
